...
import com.myMongoTest.controller.AdminMemberController;
 ...
 */
@WebMvcTest(controllers = { UserController.class, AdminMemberController.class })
...
class SecurityAccessControlTest {
    ...
    @BeforeEach
    void setUp() {
        when(userService.mongoFindAllMemo()).thenReturn(List.of());
        when(userService.mongoFindAllUser2()).thenReturn(List.of());
    }
